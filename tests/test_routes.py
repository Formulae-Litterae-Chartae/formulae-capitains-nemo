...
class TestIndividualRoutes(Formulae_Testing):
    ...
    def test_authorized_project_member(self):
        ...
        with self.client as c:
            ...
            self.assertTemplateUsed('viewer::multiviewer.html')
            c.get('/viewer/embedded/urn:cts:formulae:andecavensis.form001.lat001/7', follow_redirects=True)
            ...
            self.assertMessageFlashed('There is not an images for this formula. Showing the first page.')
            self.assertTemplateUsed('viewer::newtabviewer.html')
            c.get('/viewer/urn:cts:formulae:andecavensis.form001.lat001/7', follow_redirects=True)
            self.assertMessageFlashed('There are not 7 images for this formula. Showing the last page image instead.')
            self.assertTemplateUsed('viewer::newtabviewer.html')
            ...
            self.assertTemplateUsed('viewer::newtabviewer.html')
            c.get('/viewer/embedded/urn:cts:formulae:andecavensis.form004.lat001/7', follow_redirects=True)
            self.assertMessageFlashed('There are not 7 images for this formula. Showing the last page image instead.')
            self.assertTemplateUsed('viewer::multiviewer.html')
            c.get('/viewer/embedded/urn:cts:formulae:andecavensis.form004.lat001/-1', follow_redirects=True)
            self.assertMessageFlashed('There are not 0 images for this formula. Showing the first page image instead.')
            self.assertTemplateUsed('viewer::multiviewer.html')
